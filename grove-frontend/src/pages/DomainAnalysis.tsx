...
import AssignmentTree, { AssignmentTreeExportController } from '../components/Tree/AssignmentTree';
...
export const DomainAnalysis: React.FC = () => {
  ...
  // AssignmentTree export controller
  const treeControllerRef = React.useRef<AssignmentTreeExportController | null>(null);
          ...
          <Card title="Task Tree" description="Root → Tasks → Domains">
            <div className="flex justify-end items-center gap-2 mb-3">
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => { treeControllerRef.current?.exportPng(); }}
              >
            ...
            <div>
              <AssignmentTree
                ...
                controllerRef={treeControllerRef as any}
              />
            </div>
          </Card>
